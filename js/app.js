...
const ingredientsNotSorted = []
const applianceNotSorted = []
...
// Nouveau tableau avec les doublons suprimés
const listIngredients = ingredientsNotSorted.filter(function(ele, pos) {
    return ingredientsNotSorted.indexOf(ele) == pos;
})

// Nouveau tableau avec les doublons suprimés
const listAppliance = applianceNotSorted.filter(function(ele, pos) {
